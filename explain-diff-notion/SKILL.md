...
- Write all content for the generated Notion page in Korean, including headings, prose, diagram labels, callouts, and quiz text. Preserve code, identifiers, commands, and literal values as written.
