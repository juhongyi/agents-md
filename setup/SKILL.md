---
name: setup
description: Initialize a Python project with uv using the latest Python 3.13 version supported by uv, add the latest stable pytest and Ruff as development dependencies, ask whether other latest stable libraries are needed, copy juhongyi/skills agents-md/dev.md to the project-root AGENTS.md, and create the standard Codex environment configuration. Use when Codex needs to bootstrap or set up a Python project with this standard configuration.
---
...
7. Create `<project-root>/.codex/environments/environment.toml` with exactly the following contents:
